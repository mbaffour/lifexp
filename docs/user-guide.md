# Why I Made LifeXP: Tracking My Life So I Can Level It Up

_A privacy-first habit, time, planner, and life metrics tracker for people who want to understand where their days actually go._

LifeXP was created to make personal tracking easier, more fun, and more honest. Tracking should produce insight, not just checkmarks, and motivation matters when real life gets noisy.
...
## How analytics and reports work
...
## How to export and back up your data
...
Every tiny action counts. LifeXP helps you see them.
